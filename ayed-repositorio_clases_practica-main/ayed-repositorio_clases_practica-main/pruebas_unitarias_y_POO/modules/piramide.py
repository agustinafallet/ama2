...
class Piramide:
    ...
    def base_longitud(self, nueva_base_longitud):
        if self.base_longitud <=0:
            raise ValueError ("la base deber ser positiva")
        self.__=nueva_base_longitud
...
if __name__ == "__main__":
    piramide1=Piramide(1,2)
    vol=piramide1.volumen()
    print(vol)
    ar=piramide1.area_superficial()
    print(ar)
